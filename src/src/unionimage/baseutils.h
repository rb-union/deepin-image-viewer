...
namespace view {
    const QString DARK_DEFAULT_THUMBNAIL = ":/dark/images/empty_defaultThumbnail.png";
    const QString LIGHT_DEFAULT_THUMBNAIL = ":/light/images/empty_defaultThumbnail.png";
    const QString DARK_LOADINGICON = ":/dark/images/dark_loading.gif";
    const QString LIGHT_LOADINGICON = ":/light/images/light_loading.gif";
